      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-white/60 bg-white/80 backdrop-blur-xl">
          <div className="flex flex-col px-6 py-4 space-y-4">
            ...
            <Link
              href="/register"
              className="inline-flex h-9 items-center justify-center rounded-full bg-primary px-5 text-sm font-medium whitespace-nowrap text-primary-foreground transition hover:bg-primary/90"
            >
              Choose Our Facility Now!
            </Link>
          </div>
